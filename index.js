...
//because nested function is within the scope of myFunction which contains the variable internal.
...
function lowPopulationAnimals(info) {
  const returnArr = info.filter(item => item['population'] < 5)
...
// const testCubo = new CuboidMaker({ length: 5, width: 5, height: 5 })
// console.log(testCubo)
// console.log(testCubo.volume())
...
const testCubo = new CuboidMaker({ length: 4, width: 5, height: 5 })


// 🐴🐴🐴 Test your volume and surfaceArea methods by uncommenting the logs below: 🐴🐴🐴
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
// console.log(testCubo.volume()); // 100
// console.log(testCubo.surfaceArea()); // 130
